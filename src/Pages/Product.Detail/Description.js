            ...
            <div className="bg-light p-30">
              <div className="nav nav-tabs mb-4">
                ...
                //   className="nav-item nav-link text-dark active"
                  data-toggle="tab"
                //   href="#tab-pane-1"
                className={activeItem==='Description'?"nav-item nav-link text-dark active":"nav-item nav-link text-dark"}
                ...
                //   className="nav-item nav-link text-dark"
                  data-toggle="tab"
                //   href="#tab-pane-2"
                className={activeItem==='Information'?"nav-item nav-link text-dark active":"nav-item nav-link text-dark"}
                ...
                onClick={()=>{
                  ...
                  data-toggle="tab"
                //   href="#tab-pane-3"
                className={activeItem==='Reviews'?"nav-item nav-link text-dark active":"nav-item nav-link text-dark"}
              ...
              <div className="tab-content">
                ...
                className={activeItem==='Description'?"tab-pane fade show active":"tab-pane fade"}
                id="tab-pane-1">
                ...
                <div className={activeItem==='Information'?"tab-pane fade show active":"tab-pane fade"} id="tab-pane-2">
                ...
                <div className={activeItem==='Reviews'?"tab-pane fade show active":"tab-pane fade"} id="tab-pane-3">
                  <div className="row">
                    <div className="col-md-6">
